    ...
    return (
        <><div className="row">
            ...
            <div className="col-sm-8 col-9 text-right m-b-20">
                <a href="/admin/home/appointments/add-appointment" className="btn btn btn-primary btn-rounded float-right"><i className="fa fa-plus"></i> Add Appointment</a>
            </div>
        </div>
            <div className="row">
                                    ...
                                    <td className="text-right">
                                        <div className="dropdown dropdown-action">
                                            ...
                                            <div className="dropdown-menu dropdown-menu-right">
                                                <a className="dropdown-item" href="edit-appointment.html"><i className="fa fa-pencil m-r-5"></i> Edit</a>
